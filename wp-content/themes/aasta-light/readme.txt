...
2. Type in Aasta Light in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.

== Copyright ==

Aasta Light WordPress Theme, Copyright (c) 2020, ThemeArile
Aasta Light is distributed under the terms of the GNU GPLs
...
* Image for Screenshot Image, Credit rawpixel.com / 3353 Images
License: CC0 1.0 Universal (CC0 1.0)
License URL: https://pxhere.com/en/license
Source: https://pxhere.com/en/photo/1550717
...
= Version 1.7
* We fixed the table background color issue in the blog post area.

= Version 1.6
* We fixed the Media and text content color in the blog post area.

= Version 1.5
* Removed the left space from the wp-block-rss widget in the blog post.

= Version 1.4
* Changed the paragraph and cite tags color in the blockquote elements for blog post.

= Version 1.3
* Fixed the issue of widget title color in the sidebar.
